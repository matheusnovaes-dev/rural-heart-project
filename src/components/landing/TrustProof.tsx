      ...
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2">
        ...
        <Reveal delay={0.1}>
          ...
          <p className="mt-3 max-w-lg text-sm text-primary-foreground/70">
            Grãos (soja, milho, algodão) e agora também pecuária (boi) - quando duas fontes cobrem a
            mesma cultura e estado, cruzamos uma com a outra antes de mostrar o número.
          </p>

          <div className="mt-5 flex flex-wrap gap-2">
            {["Conab", "Imea", "Deral/PR", "Epagri/SC", "Emater/RS", "BBM", "IEA-SP"].map(
              (fonte) => (
                <span
                  key={fonte}
