...
Se a pergunta mencionar DUAS culturas (ex: "soja e milho"), chame buscar_preco pra cada uma — a segunda com incluir_frete=false — e responda sobre as duas na mesma mensagem, de forma natural; deixe claro que do segundo produto você só tem o preço, sem frete.
