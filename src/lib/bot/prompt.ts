...
export function buildContextoInstitucional(): string {
  return [
    ...
    "Como funciona: o produtor manda mensagem no WhatsApp perguntando preço de uma cultura/cidade; o Safralume cruza dados oficiais (Conab + órgãos estaduais, e quando as duas fontes cobrem a mesma cultura/estado, cruza uma com a outra) e aplica o frete líquido da região na hora, sem planilha.",
